...
import { RevokeTokenResponseDto } from 'src/modules/auth/dto/response/invoke-token-response.dto';
...
export interface IUserService {
  ...
  revokeRefreshToken(refreshToken: string): Promise<RevokeTokenResponseDto>;
}
